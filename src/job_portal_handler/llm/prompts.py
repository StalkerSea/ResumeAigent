...
is_relavant_position_template = """
   Evaluate whether the provided resume meets the requirements outlined in the job description. Determine if the candidate is suitable for the job based on the information provided. If the language is not in English or Spanish or it requires a permanent residency outside of Mexico, consider it as not meeting the requirements.
...
determine_section_template = """You are assisting a bot designed to automatically apply for jobs on AutoJobAigent. The bot receives various questions about job applications and needs to determine the most relevant section of the resume to provide an accurate response.
...
- **Examples**: Email address, phone number, AutoJobAigent profile, GitHub repository, personal website.
