...
class HelperState:
    def __init__(self):
        logger.debug("Initializing HelperState")
        self.reset()

    def reset(self):
        logger.debug("Resetting HelperState")
    ...
    def validate_state(self, required_keys):
        logger.debug(f"Validating HelperState with required keys: {required_keys}")
...
class HelperFacade:
    def __init__(self, login_component, apply_component):
        logger.debug("Initializing HelperFacade")
        self.login_component = login_component
        self.apply_component : JobManager = apply_component
    ...
    def set_parameters(self, parameters, resume_object=None):
        ...
        self.apply_component.set_parameters(parameters, resume_object)
