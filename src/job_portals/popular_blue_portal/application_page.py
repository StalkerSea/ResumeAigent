...
class PopularBluePortalApplicationPage(BaseApplicationPage):
    ...
    def has_next_button(self) -> bool:
        ...
        return "next" in button.text.lower() or "review" in button.text.lower()
    ...
    def get_input_elements(self):
        ...
        input_selectors = [
            ...
            ".fb-dash-form-element"  # Add this new selector
        ]
        elements = []
    ...
    def has_submit_button(self) -> bool:
        ...
        return "submit application" in submit_button.text.lower()
    ...
    def click_submit_button(self) -> None:
        ...
        if "submit application" not in submit_button.text.lower():
    ...
    def uncheck_follow_company(self) -> None:
        try:
            ...
            try:
                checkbox = self.driver.find_element(By.ID, "follow-company-checkbox")
                if checkbox.is_selected():
                    # Use JavaScript to click since it's hidden
                    self.driver.execute_script("arguments[0].click();", checkbox)
                    logger.debug("Unchecked 'Follow Company' checkbox")
            except Exception as e:
                logger.warning(f"Could not uncheck 'Follow Company' checkbox: {e}")
